...
def plot_density_3d(ax, samples, T_arr, n_bins=100):
    ...
    X_grid, Y_grid = np.meshgrid(T_arr, bin_centers)
    ax.plot_surface(X_grid, Y_grid, density.T, 
                    color="skyblue",
                    alpha=0.6,
                    rstride=1, 
                    cstride=1,
...
plot_density_3d(axs[0], X_arr[..., 0], T_arr)
axs[0].set_xlabel(r'$T$')
axs[0].set_ylabel(r'$x_1$')
axs[0].set_zlabel('Density')
axs[0].set_title(r'$x_1$ Distribution')

plot_density_3d(axs[1], X_arr[..., 1], T_arr)
axs[1].set_xlabel(r'$T$')
axs[1].set_ylabel(r'$x_2$')
axs[1].set_zlabel('Density')
axs[1].set_title(r'$x_2$ Distribution')
plt.show()
